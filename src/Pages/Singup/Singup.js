    ...
    return (
        <div className='bg-gray-900'>
            <div className='text-center text-white pt-6'>
                <h1 className='text-3xl font-sans'>Welcome to medishop</h1>
                <p>create an account here!! </p>
            </div>
            <form className='w-2/4 mx-auto h-screen pt-16'>
                ...
                <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Singup Now</button>
